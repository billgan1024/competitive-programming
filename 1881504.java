...
public class ConvexHull {
	...
	static void shortestPath(int o, int f, ArrayList<Edge>[] adj, int[][] dis)
	{
		...
		while(!pq.isEmpty())
		{
			Edge cur = pq.remove(); if(cur.v == f) { System.out.println(dis[cur.v][cur.d]); return; }
			if(dis[cur.v][cur.d] < cur.w) continue;
	...
	public static void main(String[] args) throws IOException {
		...
		int[][] dis = new int[n+1][k]; shortestPath(a, b, adj, dis);
	}
