...
public class FunInForag {
	...
	{
		//make sure this is above the maximum distance that can be achieved
		//but less than the long overflow limit (9e18)
		//max distance is edges*cost = 2e11
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 1; i <= n; i++)
		{
			long[] dis = new long[2]; int[] level = new int[2];
