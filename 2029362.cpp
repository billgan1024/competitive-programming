...
int main()
{
    ...
    for(pii c : mud)
    {
        //since you can jump any distance up to j, for each tile that is added, 
        //connect it to the furthest tiles it can reach (this tile is guaranteed to be 
        //connected to all the tiles closer than the furthest tiles)
        //finally, check if 0 and n+1 is connected at this time
