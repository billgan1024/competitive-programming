		...
		for(int r = 0; r < rows; r++)
		{
			for(int c = 0; c < cols; c++)
			{
				...
				while(!queue_r.isEmpty())
				{
					...
					if(vis[cur_r][cur_c]) {
						//if this loop touches itself, then this is a new connected component
						//otherwise it is actually connected to another connected component
						//so don't add 1 to components
						boolean yes = false;
